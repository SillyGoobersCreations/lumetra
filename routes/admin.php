...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/events/{eventId}/eventSettings', [EventSettingsController::class, 'showIndex'])->name('events.admin.eventSettings');
    Route::post('/events/{eventId}/eventSettings', [EventSettingsController::class, 'doSave'])->name('events.admin.eventSettings.doSave');
    Route::post('/events/{eventId}/eventSettings/logo', [EventSettingsController::class, 'doSaveLogo'])->name('events.admin.eventSettings.doSaveLogo');
    Route::get('/events/{eventId}/eventSettings/clearLogo', [EventSettingsController::class, 'doClearLogo'])->name('events.admin.eventSettings.doClearLogo');
});
