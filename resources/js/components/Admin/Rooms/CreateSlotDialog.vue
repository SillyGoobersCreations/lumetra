            ...
            <div class="flex flex-col gap-4 mb-2">
                <FormRow label="Start Time" :error="false">
                    <div class="flex gap-2 items-center">
                        <Input type="number" placeholder="08" v-model="form.start_hour" />
                        <span>:</span>
                        <Input type="number" placeholder="00" v-model="form.start_minute" />
                    </div>
                </FormRow>
                <FormRow label="End Time" :error="false">
                    <div class="flex gap-2 items-center">
                        <Input type="number" placeholder="16" v-model="form.end_hour" />
                        <span>:</span>
                        <Input type="number" placeholder="00" v-model="form.end_minute" />
                    </div>
                </FormRow>
                <FormRow label="Notes" :error="form.errors.notes">
                    <Textarea v-model="form.notes" />
                </FormRow>
                <FormRow label="State" :error="form.errors.state">
...
function sendForm() {
    form.post(route('events.admin.rooms.slots.create', {
